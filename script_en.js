...
const timelineData = [
    {
        ...
        keyFigures: [`Lin Jiang-mai (Tobacco Vendor)`, `Chen Wen-xi (Innocent Victim)`, `Fu Hsueh-tung (Investigator who Fired)`],
...
window.onload = () => {
    initHeroCarousel();
    startRandomScenario(); // Initialize randomly loaded scenario
