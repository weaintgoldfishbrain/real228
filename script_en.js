...
const factChecks = [
    ...
    { claim: ""The Taiwanese at that time were subjected to Japanese enslavement education, which is why they rebelled."", reality: "參與「處理委員會」提出改革要求的多為受過高等教育的知識份子。他們是基於對Chen Yi政府貪腐無能、物價飛漲與特權壟斷的不滿，提出縣市長民選等近代民主訴求，與「奴化」毫無關聯。" },
    { claim: ""If troops had not been sent to suppress it, Taiwan would have been taken over by the Communists long ago."", reality: "當時台灣的共產黨員人數極少（根據檔案僅數十人），根本無法策動全島抗爭。將二二八定調為共產黨叛亂，完全是Chen Yi為了掩飾施政失敗，並說服Chiang Kai-shek派兵鎮壓所羅織的藉口。" }
];
